...
class Alerts {
  Future<void> createAlerts(BuildContext buildContext, AlertsDto alertsDto) async {
    const url = http + baseURL + createAlertsPath;
    logger.i(url);
    logger.i(json.encode({
      "title": alertsDto.title.toString(),
      "description":
      alertsDto.description.toString(),
      "image":
      alertsDto.image.toString(),
